...
Set starting_ws = ActiveSheet 'remember which worksheet is active in the begi
...
For Each ws In ThisWorkbook.Worksheets
    ...
    'function to find maximum growth and loss, as well as max total volume
    ...
    'set cell values determined above
    ...
    'setting coniditional formatting parameters, greater than zero is given green, less than zero is given red
    Set greater_than_zero = Range("J2:K3200").FormatConditions.Add(xlCellValue, xlGreater, "=0")
    Set less_than_zero = Range("J2:K3200").FormatConditions.Add(xlCellValue, xlLess, "=0")
